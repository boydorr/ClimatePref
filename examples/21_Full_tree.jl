...
heatmap(y, x, transpose(lambdas), seriescolor = cgrad([:red, :white, :blue], [0, mean(lambdas), 1]), 
colorbar = :legend, legend = :top, size = (900, 400), guidefontsize = 12, tickfontsize = 12, xrotation = 90, 
clim = (0, 1), colorbar_title = "λ", layout = (@layout [a; b]), title = "A", title_loc = :left, titlefontsize = 16)
...
heatmap!(y, x, transpose(lambdas), seriescolor = cgrad([:red, :white, :blue], [0, mean(lambdas), 1]), 
colorbar = :legend, legend = :top, size = (900, 400), guidefontsize = 12, tickfontsize = 12, xrotation = 90, 
clim = (0, 1), colorbar_title = "λ", subplot = 2, title = "B", title_loc = :left, titlefontsize = 16)
Plots.pdf("examples/FullLambda.pdf")
