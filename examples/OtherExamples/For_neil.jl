...
extras = map(x -> string(split(x, " ")[1], " ", split(x, " ")[2], " ",
                         split(x, " ")[3], " ", split(x, " ")[4]), syns)
extras2 = map(x -> string(split(x, " ")[1], " ", split(x, " ")[2], " ",
                          split(x, " ")[3]), syns)
...
using FileIO
FileIO.save("/Users/claireh/Documents/PhD/Data/For_neil/matches_without_synonyms.csv",
            total)
...
FileIO.save("/Users/claireh/Documents/PhD/Data/For_neil/matches_with_synonyms.csv",
            total_syn)
