...
for i in eachindex(y)
    if i == 1
        ...
        p = plot!(x[2:3], lambdas[i, 2:3], line = :dot, label = "",
                  color = mygrad[i])
    else
        p = plot!(x[1:2], lambdas[i, 1:2], label = y[i], color = mygrad[i])
        p = plot!(x[2:3], lambdas[i, 2:3], line = :dot, label = "",
...
heatmap(x, y, lambdas, seriescolor = :Blues, clim = (0, 1), guidefontsize = 10,
        tickfontsize = 10, size = (500, 500), top_margin = 20px,
        bottom_margin = 20px, colorbar_title = "λ")
...
h = heatmap(x, y, corrs, seriescolor = :RdBu, clim = (-1, 1), layout = (1, 2),
            subplot = 1, title = "Imputed data", size = (700, 500),
...
bar(tmin[418:815], solanum_dulcamara[418:815], layout = (3, 1), subplot = 1,
    size = (600, 800), grid = false, fillcolor = 1, linecolor = :match,
    legend = false)
bar!(tmin[418:815], solanum_dulcamara[418:815] .* adjustment1[418:815, 1],
     layout = (3, 1), subplot = 2, size = (600, 800), grid = false,
     fillcolor = 2, linecolor = :match, legend = false)
bar!(tmin[418:815], solanum_dulcamara[418:815] .* adjustment2[418:815, 1],
     layout = (3, 1), subplot = 3, size = (600, 800), grid = false,
     fillcolor = 3, linecolor = :match, legend = false)
...
# Apply adjustment to data grouped by Species ID
phylo_traits_tmin = @groupby gbif_fil :SppID {tmin10 = adjust_percentile(uconvert.(K,
                                                                                   :tmin),
                                                                         adjustment[:,
                                                                                    1],
                                                                         mins[1],
                                                                         maxs[1],
                                                                         10),
                                              tmin20 = adjust_percentile(uconvert.(K,
                                                                                   :tmin),
                                                                         adjustment[:,
                                                                                    1],
                                                                         mins[1],
                                                                         maxs[1],
                                                                         20),
                                              tmin30 = adjust_percentile(uconvert.(K,
                                                                                   :tmin),
                                                                         adjustment[:,
                                                                                    1],
                                                                         mins[1],
                                                                         maxs[1],
                                                                         30),
                                              tmin40 = adjust_percentile(uconvert.(K,
                                                                                   :tmin),
                                                                         adjustment[:,
                                                                                    1],
                                                                         mins[1],
                                                                         maxs[1],
                                                                         40),
                                              tmin50 = adjust_percentile(uconvert.(K,
                                                                                   :tmin),
                                                                         adjustment[:,
                                                                                    1],
                                                                         mins[1],
                                                                         maxs[1],
                                                                         50),
                                              tmin60 = adjust_percentile(uconvert.(K,
                                                                                   :tmin),
                                                                         adjustment[:,
                                                                                    1],
                                                                         mins[1],
                                                                         maxs[1],
                                                                         60),
                                              tmin70 = adjust_percentile(uconvert.(K,
                                                                                   :tmin),
                                                                         adjustment[:,
                                                                                    1],
                                                                         mins[1],
                                                                         maxs[1],
                                                                         70),
                                              tmin80 = adjust_percentile(uconvert.(K,
                                                                                   :tmin),
                                                                         adjustment[:,
                                                                                    1],
                                                                         mins[1],
                                                                         maxs[1],
                                                                         80),
                                              tmin90 = adjust_percentile(uconvert.(K,
                                                                                   :tmin),
                                                                         adjustment[:,
                                                                                    1],
                                                                         mins[1],
...
phylo_traits_tmax = @groupby gbif_fil :SppID {tmax10 = adjust_percentile(uconvert.(K,
                                                                                   :tmax),
                                                                         adjustment[:,
                                                                                    1],
                                                                         mins[1],
                                                                         maxs[1],
                                                                         10),
                                              tmax20 = adjust_percentile(uconvert.(K,
                                                                                   :tmax),
                                                                         adjustment[:,
                                                                                    1],
                                                                         mins[1],
                                                                         maxs[1],
                                                                         20),
                                              tmax30 = adjust_percentile(uconvert.(K,
                                                                                   :tmax),
                                                                         adjustment[:,
                                                                                    1],
                                                                         mins[1],
                                                                         maxs[1],
                                                                         30),
                                              tmax40 = adjust_percentile(uconvert.(K,
                                                                                   :tmax),
                                                                         adjustment[:,
                                                                                    1],
                                                                         mins[1],
                                                                         maxs[1],
                                                                         40),
                                              tmax50 = adjust_percentile(uconvert.(K,
                                                                                   :tmax),
                                                                         adjustment[:,
                                                                                    1],
                                                                         mins[1],
                                                                         maxs[1],
                                                                         50),
                                              tmax60 = adjust_percentile(uconvert.(K,
                                                                                   :tmax),
                                                                         adjustment[:,
                                                                                    1],
                                                                         mins[1],
                                                                         maxs[1],
                                                                         60),
                                              tmax70 = adjust_percentile(uconvert.(K,
                                                                                   :tmax),
                                                                         adjustment[:,
                                                                                    1],
                                                                         mins[1],
                                                                         maxs[1],
                                                                         70),
                                              tmax80 = adjust_percentile(uconvert.(K,
                                                                                   :tmax),
                                                                         adjustment[:,
                                                                                    1],
                                                                         mins[1],
                                                                         maxs[1],
                                                                         80),
                                              tmax90 = adjust_percentile(uconvert.(K,
                                                                                   :tmax),
                                                                         adjustment[:,
                                                                                    1],
                                                                         mins[1],
...
phylo_traits_tp = @groupby gbif_fil :SppID {tp10 = adjust_percentile(uconvert.(mm,
                                                                               :tpmean),
                                                                     adjustment[:,
                                                                                14],
                                                                     mins[2],
                                                                     maxs[2],
                                                                     10),
                                            tp20 = adjust_percentile(uconvert.(mm,
                                                                               :tpmean),
                                                                     adjustment[:,
                                                                                14],
                                                                     mins[2],
                                                                     maxs[2],
                                                                     20),
                                            tp30 = adjust_percentile(uconvert.(mm,
                                                                               :tpmean),
                                                                     adjustment[:,
                                                                                14],
                                                                     mins[2],
                                                                     maxs[2],
                                                                     30),
                                            tp40 = adjust_percentile(uconvert.(mm,
                                                                               :tpmean),
                                                                     adjustment[:,
                                                                                14],
                                                                     mins[2],
                                                                     maxs[2],
                                                                     40),
                                            tp50 = adjust_percentile(uconvert.(mm,
                                                                               :tpmean),
                                                                     adjustment[:,
                                                                                14],
                                                                     mins[2],
                                                                     maxs[2],
                                                                     50),
                                            tp60 = adjust_percentile(uconvert.(mm,
                                                                               :tpmean),
                                                                     adjustment[:,
                                                                                14],
                                                                     mins[2],
                                                                     maxs[2],
                                                                     60),
                                            tp70 = adjust_percentile(uconvert.(mm,
                                                                               :tpmean),
                                                                     adjustment[:,
                                                                                14],
                                                                     mins[2],
                                                                     maxs[2],
                                                                     70),
                                            tp80 = adjust_percentile(uconvert.(mm,
                                                                               :tpmean),
                                                                     adjustment[:,
                                                                                14],
                                                                     mins[2],
                                                                     maxs[2],
                                                                     80),
                                            tp90 = adjust_percentile(uconvert.(mm,
                                                                               :tpmean),
                                                                     adjustment[:,
                                                                                14],
                                                                     mins[2],
...
phylo_traits_tmin = pushcol(phylo_traits_tmin, :tipNames,
                            join.(split.(new_cross_species, " "), "_"))
phylo_traits_tmax = pushcol(phylo_traits_tmax, :tipNames,
                            join.(split.(new_cross_species, " "), "_"))
phylo_traits_tp = pushcol(phylo_traits_tp, :tipNames,
                          join.(split.(new_cross_species, " "), "_"))

# Filter for common species
phylo_traits_tmin = filter(p -> p.tipNames in join.(split.(top_common_names,
                                                           " "), "_"),
                           phylo_traits_tmin)
phylo_traits_tmax = filter(p -> p.tipNames in join.(split.(top_common_names,
                                                           " "), "_"),
                           phylo_traits_tmax)
phylo_traits_tp = filter(p -> p.tipNames in join.(split.(top_common_names, " "),
                                                  "_"), phylo_traits_tp)
